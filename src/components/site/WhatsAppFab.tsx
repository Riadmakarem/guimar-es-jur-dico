...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full border border-gold/50 bg-gold px-5 py-3.5 text-navy-deep shadow-gold transition-transform hover:scale-105"
    >
