    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <Link to="/" className="group flex items-center gap-3">
          <img
            src={headerImg}
            alt="Abraão Guimarães"
            className="h-10 w-10 rounded-sm border border-gold object-cover"
          />
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <a
            ...
            className="rounded-sm bg-gold px-5 py-2.5 text-sm font-medium text-navy-deep transition-all hover:shadow-gold"
          >
            Fale comigo
          </a>
        </nav>
        ...
        <nav className="border-t border-border bg-background md:hidden">
          <div className="mx-auto flex max-w-6xl flex-col gap-1 px-6 py-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 rounded-sm bg-gold px-4 py-2.5 text-center text-sm font-medium text-navy-deep"
            >
              Fale comigo
            </a>
          </div>
